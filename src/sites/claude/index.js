  ...
  contentTypes: [
    {
      ...
      // Claude conversations live at /share/{id} (shared) and /chat/{id} (active chat).
      pathPatterns: [/^\/share\//i, /^\/chat\//i]
    }
  ],
